...
//==============================================================================
// Main Class for applet ObjectDiff
//
//==============================================================================
//{{PROJECT_CLASS_DECL
public class ObjectDiff extends ObjectDiffBase
//END_PROJECT_CLASS_DECL}}
{
	// THREAD SUPPORT:
	//		m_ObjectDiff	is the Thread object for the applet
	...
	public static void main(String args[])
	{
		...
		JFrame frame = new JFrame("ObjectDiff");
		...
		ObjectDiff applet_ObjectDiff = new ObjectDiff();
		
		frame.getContentPane().add("Center", applet_ObjectDiff);
		
		applet_ObjectDiff.init();
		applet_ObjectDiff.start();
		frame.setVisible(true);
